...
<head>
  <meta charset='UTF-8'>
  <title>Ionic angular-chart line example</title>
...
<link href='https://raw.githubusercontent.com/jtblin/angular-chart.js/master/dist/angular-chart.css' rel='stylesheet'>
...
<body ng-controller='GraphCtrl'>
  ...
  <ion-content>
    ...
    <canvas id='bar' class='chart chart-line' data='graph.data' labels='graph.labels' series='graph.series' height='50'></canvas>
  </ion-content>
